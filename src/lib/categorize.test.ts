...
describe('guessCategoryFromName', () => {
  it('recognizes common car-audio product names', () => {
    ...
    expect(guessCategoryFromName('4-Channel Amplifier')).toBe('four_five_channel_amp')
    expect(guessCategoryFromName('5 Channel Amp')).toBe('four_five_channel_amp')
    expect(guessCategoryFromName('4/5 Channel Amplifier')).toBe('four_five_channel_amp')
    expect(guessCategoryFromName('2-Channel Amplifier')).toBe('multi_amp')
    expect(guessCategoryFromName('6-Channel Amplifier')).toBe('multi_amp')
